...
export function NewsletterSection() {
    ...
    // Fetch token when the modal opens
    useEffect(() => {
        if (isOpen && !tokenData) {
            fetchToken()
        }
                    ...
                    <div className="flex flex-col space-y-5">
                        <div className="space-y-1">
                            ...
                            <DialogDescription className="text-sm text-muted-foreground">
                                Subscribe to mailing lists directly using your
                                private email alias.
                            </DialogDescription>
                        </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-muted-foreground leading-relaxed">
                                        Paste this private email address in the
                                        subscription form of Substack,
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-muted-foreground leading-relaxed">
                                        ...
                                        automatically create the feed and place
                                        it in your{" "}
