# Privacy Policy for the Infrss Browser Extension

Last updated: September 13, 2026

## Overview

Infrss helps users collect web reading material in their Infrss account by saving webpage articles and subscribing to RSS feeds discovered on websites they visit. This policy explains how the Infrss browser extension handles information.

## Information We Handle

### Account and Authentication Information

- Email address and basic Infrss account profile information
...
We use this information only to provide Infrss's article-saving, feed-discovery, authentication, synchronization, and content-organization features. We do not use it for advertising, creditworthiness, lending, or unrelated profiling.
...
Articles, feeds, account information, and related metadata that the user sends to a Infrss server are retained according to that server's policies and the user's account settings. Users can manage saved content through their Infrss account.

## Sharing and Service Providers

The extension communicates with:

- The official Infrss service or the self-hosted Infrss server selected by the user
...
We do not sell user data. We do not transfer user data to advertising platforms, data brokers, or other third parties except service providers necessary to deliver Infrss, transfers requested by the user, security or legal requirements, or other cases permitted by the Chrome Web Store User Data Policy.
...
Users can disable or uninstall the extension at any time. Uninstalling removes extension-local data according to browser behavior. Users can manage or delete server-stored articles and feeds through their Infrss account. For requests concerning account data, contact admin@readspace.ai.
